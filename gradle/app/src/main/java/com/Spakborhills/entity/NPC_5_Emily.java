...
public class NPC_5_Emily extends Entity {
    ...
    public void getImage(){
        up1 = setup("/npc/emily/e3");
        up2 = setup("/npc/emily/e3");
        down1 = setup("/npc/emily/e1");
        down2 = setup("/npc/emily/e2");
        left1 = setup("/npc/emily/e5");
        left2 = setup("/npc/emily/e5");
        right1 = setup("/npc/emily/e4");
        right2 = setup("/npc/emily/e4");
    }
