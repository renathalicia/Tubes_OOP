...
public class TileManager {
    ...
    public TileManager(GamePanel gp) {
        ...
        getTileImage();
        loadMap(0, "/maps/FarmMap.txt");
        loadMap(1, "/maps/Ocean.txt");
        loadMap(2, "/maps/InteriorOcean.txt");

        loadMap(3, "/maps/MountainLake.txt");
        loadMap(4, "/maps/ForestRiver.txt");
        loadMap(5, "/maps/interiorfarmhouse.txt");
        loadMap(6, "/maps/interiorstore.txt");
        loadMap(7, "/maps/InteriorMountainLake.txt");
        loadMap(8, "/maps/InteriorMountainLake1.txt");
        loadMap(9, "/maps/InteriorForestRiver.txt");
        loadMap(10, "/maps/InteriorForestRiver1.txt");
