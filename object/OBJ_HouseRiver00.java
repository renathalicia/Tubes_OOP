...
public class OBJ_HouseRiver00 extends SuperObject {
    GamePanel gp;
    ...
    public OBJ_HouseRiver00(GamePanel gp) {
        ...
        try {
            ...
            BufferedImage originalImage = ImageIO.read(getClass().getResourceAsStream("/res/objects/houseriver00.png"));
            ...
            if (originalImage != null) {
                ...
                System.err.println("OBJ_House: Gambar asli untuk FarmHouse null. Path mungkin salah: /res/objects/beachhouse.png");
            }
        } catch (IOException e) {
            e.printStackTrace();
