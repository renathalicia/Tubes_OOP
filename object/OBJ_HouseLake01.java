...
public class OBJ_HouseLake01 extends SuperObject {
    GamePanel gp;
    ...
    public OBJ_HouseLake01(GamePanel gp) {
        ...
        try {
            ...
            BufferedImage originalImage = ImageIO.read(getClass().getResourceAsStream("/res/objects/houselake01.png"));
