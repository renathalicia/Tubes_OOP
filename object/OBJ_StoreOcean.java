...
public class OBJ_StoreOcean extends SuperObject {
    GamePanel gp;
    ...
    public OBJ_StoreOcean(GamePanel gp) {
        ...
        try {
            ...
            BufferedImage originalImage = ImageIO.read(getClass().getResourceAsStream("/res/objects/storeocean.png"));
