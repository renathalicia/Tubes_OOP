...
public class CropObject {
    ...
    private void loadCropImages() {
        ...
        try {
            ...
            seedImage = ImageIO.read(getClass().getResourceAsStream("/res/item/seeds/" + baseName + "1.png"));
            growingImage = ImageIO.read(getClass().getResourceAsStream("/res/item/seeds/" + baseName + "2.png"));
            readyImage = ImageIO.read(getClass().getResourceAsStream("/res/item/seeds/" + baseName + "3.png"));
